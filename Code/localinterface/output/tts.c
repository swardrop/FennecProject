...
{
    int error = 0;
    char sclc[] = {0x014 0x00};     /* Command set clock reg for 24.576MHz */
    ...
    char scod[] = {0x01, 0x04};     /* Command set codecs reg for codecs disabled TODO */
    char saud[] = {0x05, 0x40};     /* Command set audio reg for speaker out only */
